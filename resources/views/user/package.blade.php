...
<div class="container">
    ...
    <div class="container container-card-deck container-decorate">
        ...
        <div class="row mx-auto col-10 ">
            <table class="tablePackage table" style="margin: 1.5em;">
                ...
                @foreach($packages as $p)
                    <tr>
                        <td><li style="list-style: none;">{{$p->package_cost}}</li></td>
                        <td><li style="list-style: none;">{{$p->max_balance}}</li></td>
                        <td><li style="list-style: none;">{{$p->max_withdraw}}</li></td>
                        <td class="mx-auto">
                            <form action="remove-package/{{$p->id}}" method="post">
                                {{csrf_field()}}
                                <li style="list-style: none;"><button class="btnDelete primary-color-btn">Remove</button></li>
                            </form>
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="row col-10 mx-auto">
            ...
            <form class="row" action="add-package" method="post">
                {{csrf_field()}}
