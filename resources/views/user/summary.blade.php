        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="container bg-light rounded sticky-positioning" style="padding: 3em;">
                    ...
                    <br>
                    <div class="progress">
                        <div class="progress-bar w-50" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <br>
                    <div class="progress">
                        <div class="progress-bar w-100" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <br>
                    <div class="progress">
                        <div class="progress-bar w-25" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
...
{{--                kasi paginate aja dah--}}
            <div class="col-sm-7" style="padding: 1em 3em 1em 3em;">
                @foreach($summaries as $s)
                    <img src="{{asset('images/carousel/sushi.jpg')}}" alt="" class="profile-picture-style border border-dark">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="{{asset('images/black.jpg')}}" alt="Card image cap" style="height: 13em;">
                    <div class="card-body">
